...
export default {
  ...
  computed: {
    ...
    shopList() {
      return shopListStore.getShopsList;
    },
    deliveryMethodsList() {
        ...
        if (!this.entryData.row) {
          ...
          this.$axios
            ...
            .then(({ data: { storehouseData } }) => {
              storehouseStore.addToStorehouseData(
          ...
          if (!isEmpty(sendData)) {
            ...
            this.$axios
              ...
              .then(({ data: { storehouseData } }) => {
                ...
                storehouseStore.updateStorehouseData(formatedData);
                faxesStore.updateFaxData(formatedData).catch((e) => {
