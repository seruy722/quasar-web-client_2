<template>
  <q-timeline data-vue-component-name="StorehouseDataHistory" color="secondary">
    ...
    >
      <List separator dense>
        <div v-for="(history, i) in transfer" :key="i">
          <ListItem v-if="faxHistoryData.cols[i] && i !== 'created_at'" dense>
            <ItemSection>
              <ItemLabel
                v-if="
            ...
            <ItemSection side>
              ...
              <ItemLabel v-else-if="i === 'status_label'">
