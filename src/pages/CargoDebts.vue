<template>
  <q-page data-vue-component-name="CargoDebts">
    <PullRefresh @refresh="refresh">
      <div v-show="tab !== 'general'" class="row justify-center">
        <SearchSelect
        ...
        <q-card>
          ...
          <q-tab-panels v-model="tab" animated swipeable>
            <q-tab-panel name="general">
              <q-card bordered style="margin-bottom: 30px">
...
export default {
  ...
  computed: {
    ...
    generalCargoData() {
      return (
        get(cargoDebtsStore.getGeneralData, "cargo") || {
          kg: 0,
          sale: 0,
          place: 0,
          sum: 0,
    ...
    generalDebtsData() {
      return (
        get(cargoDebtsStore.getGeneralData, "debts") || {
          sum: 0,
          commission: 0,
          visible: true,
        }
  ...
  async created() {
    const { getClientCodes } = await import(
