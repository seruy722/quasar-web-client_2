<template>
  <q-page data-vue-component-name="StorehouseComponent">
        ...
        <template #top-buttons>
          <div class="row q-gutter-sm">
            ...
            <RoundBtn
              ...
              :tooltip="$t('delete')"
              @round-btn-click="
                destroyEntry(storehouseTableReactiveProperties.selected)
              "
            />
        ...
        <template #inner-item="{ props }">
          ...
          >
            ...
            >
              ...
              <q-list separator dense @click="viewUpdateDialog(props)">
                <q-item
...
import { isEmpty, includes, get, map, size } from "lodash";
...
export default {
  ...
  computed: {
    ...
    storehouseCategoriesData() {
      return storehouseStore.getStorehouseCategoriesData;
    },
  },
  mounted() {
    this.loading = true;
    Promise.all([getStorehouseTableData(storehouseStore)]).then(() => {
      this.loading = false;
    });
  },
  methods: {
    ...
    viewUpdateDialog(val, event) {
      if (!includes(get(event, "target.classList"), "select_checkbox")) {
        ...
        this.localStorehouseEditData.historyFunc =
          this.getStorehouseDataHistory;
            ...
            },
            {
              ...
              handler: () => {
                ...
                this.$axios
                  ...
                  .catch(() => {
                    console.error("Ошибка запроса - destroyStorehouseData");
                  });
              },
            },
          ],
    ...
    exportStorehouseData() {
      if (!isEmpty(this.storehouseData)) {
        this.exportDataToExcel(
          getUrl("exportStorehouseData"),
          {
            ids: map(this.storehouseTableReactiveProperties.selected, "id"),
          },
          "На складе.xlsx",
        );
      }
