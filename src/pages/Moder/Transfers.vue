...
export default defineComponent({
  ...
  setup() {
    ...
    const allTransfers = computed(() => transfersStore.getTransfers);
    const clientCodes = computed(() => codesStore.getCodes);

    PusherFunc(transfersStore);
    ...
    async function refresh() {
      loading.value = true;
      return transfersStore.fetchTransfers().finally(() => {
        loading.value = false;
      });
    }
