<template>
  <q-card data-vue-component-name="PasswordRecovery" flat>
    <q-card-section>
      <q-form v-show="!yesPhoneInDB" class="q-gutter-md" @submit="onSubmit">
        <q-input
          v-model="phone"
          hint="380501414144"
          type="tel"
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$axios
        .post(getUrl("changePasswordCode"), sendData)
